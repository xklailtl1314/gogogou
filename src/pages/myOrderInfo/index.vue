  ...
  <div class="my-wait-receive">
    ...
    <div class="step-info">
      <div class="top">
        ...
        <div class="wrap">
          <span class="tit">订单完成</span>
        </div>
      </div>
      <div class="bottom">
        <div class="step complate">买家付款</div>
        <div class="step complate">商家发货</div>
        <div class="step active">交易完成</div>
      </div>
    </div>
    ...
    <div class="address-info">
      ...
      <div class="r">
        <div class="t">
          <span class="left">到上海市【上海杨浦区十六部】</span>
          <span class="right">
            <i class="iconfont icon-angle-right"></i>
          </span>
        </div>
        <div class="b">2019-12-04 07:36:20</div>
      </div>
    </div>
    <!-- 地址信息 -->
    <div class="address-info">
      ...
      <div class="r">
        <div class="t">
          <span class="left">收货人：邱敏</span>
          <span class="right">13636320811</span>
        </div>
        <div class="b">收货地址：上海市杨浦区 包头路1150弄 城市名园22号403室</div>
      </div>
    </div>
    ...
    <div class="shop">
      ...
      <div class="oList">
        ...
        <div class="item">
          ...
          <div class="r">
            <span>微信支付</span>
            <span class="sub">有赞提供资金担保，确保收货后才结算给商家</span>
          </div>
        </div>
        <div class="item right-end">
          <div class="r">
            <span>实付款:</span>
            <span class="price">￥6.9</span>
          </div>
      ...
      <div class="order-info">
        <div class="item">
          ...
          <div class="r">
            <span>E20191203144345092900003</span>
            <label>复制</label>
          </div>
        </div>
        <div class="item">
          ...
          <div class="r">
            <span>2019-12-03 14:43:45</span>
          </div>
        </div>
        <div class="item">
          <span class="l">付款时间：</span>
          <div class="r">
            <span>2019-12-03 14:44:17</span>
          </div>
        </div>
        <div class="item">
          <span class="l">发货时间：</span>
          <div class="r">
            <span>2019-12-03 17:22:59</span>
          </div>
        </div>
      </div>
    ...
    <!-- 确认收货 -->
    <button class="btn-submit" @click="goToComment">去评价</button>
  </div>
</template>
